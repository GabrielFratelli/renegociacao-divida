...
describe('SimuladorPropostaComponent', () => {
  const divida: Divida = { id: 'd-1', credor: 'Banco Aurora', descricao: 'Cartão', valorOriginal: 1000, vencimento: '2026-05-10', status: 'ATRASADA' };
  ...
  const rota = { snapshot: { queryParamMap: parametros }, queryParamMap: of(parametros) };
  ...
  it('solicita uma proposta para a dívida selecionada', () => {
    propostas.simular.mockReturnValue(of({ dividaId: 'd-1', valorOriginal: 1000, desconto: 100, valorFinal: 900, quantidadeParcelas: 1, valorParcela: 900, vencimentoPrimeiraParcela: '2026-09-01', mensagem: 'Proposta válida' }));
    const fixture = TestBed.createComponent(SimuladorPropostaComponent);
    const componente = fixture.componentInstance;

    componente.simular();

    expect(propostas.simular).toHaveBeenCalledWith(expect.objectContaining({ dividaId: 'd-1', tipoPagamento: 'A_VISTA', quantidadeParcelas: undefined }));
