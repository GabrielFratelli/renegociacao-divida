...
describe('PropostasService', () => {
  ...
  it('deve enviar os parâmetros da simulação ao BFF', () => {
    servico.simular({ dividaId: 'd-1', tipoPagamento: 'PARCELADO', quantidadeParcelas: 6, dataPrimeiroVencimento: '2026-09-01' }).subscribe((proposta) => {
    ...
    requisicao.flush({ dividaId: 'd-1', valorOriginal: 1000, desconto: 100, valorFinal: 900, quantidadeParcelas: 6, valorParcela: 150, vencimentoPrimeiraParcela: '2026-09-01', mensagem: 'Proposta válida' });
  });
});
